...
const AddItem = () => {
    const handleAddCraft = (e) => {
        ...
        console.log(name, price, image, category, subCategory, shortDescription, stockStatus, customization, procesingTime, rating, userName, userEmail)
    ...
    return (
        <div className="gadgetContainer pt-10 mb-6">
