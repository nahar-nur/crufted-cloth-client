...
const Register = () => {
    ...
    const { createUser, signInUser, signInWithGoogle, githubSignIn } = useContext(AuthContext) || {}
    // google sign in
...
[#FF497C] inline-block rounded py-1 px-2 hover:text-white duration-200"
            ...
            <div className="flex items-center flex-wrap md:flex-nowrap gap-4 mb-4 w-full ">
                <button
                ...
                >
                    <div className="bg-white p-2 rounded-full flex items-center flex-wrap md:flex-nowrap gap-4 mb-4 ">
